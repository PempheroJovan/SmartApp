...
class Qs
{
 ...
 <div class="alert alert-success alert-bordered">
    ...
    public static function getTeamAcademic()
    {
     ...
     public static function getTeamViewer()
    {
        return ['admin', 'super_admin','teacher','student'];
    }
    ...
    //calculate total points from theR
    ...
    public static function findStudentRecord($user_id)
    {
     ...
     //count students  
    public static function totalStudents($section_id)
    {
        $d = ['section_id' => $section_id];
        return StudentRecord::where($d)->count('user_id');
    }

    /*get students points.
    public static function totalPoints($code_id)
    {
        $d = ['id' => $code_id];
        return StudentRecord::where($d)->count('user_id');
    }
