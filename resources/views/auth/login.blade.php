...
@section('content')
    <div class="page-content login-co">
         <style>
            body {
              background-image: url('global_assets/images/login-cover.jpg');
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex align-items-center">
                                ...
                                <a href="{{ route('password.request') }}" class="ml-auto"><!--b>Forgot password?</b--></a>
                            </div>
