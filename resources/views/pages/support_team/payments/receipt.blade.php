...
<div class="container">
    <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
        ...
        <table width="100%">
          ...
          <tr>
            <td><img src="{{ asset('global_assets/images/logo.png') }}" style="max-height : 100px;width:100px;margin-top: -15px"></td>
          </tr>
            <tr>
       ...
       <div style="float: left; margin-left: 20px">
        ...
        <table class="td-left" style="font-size: 16px" width="100%" cellspacing="2" cellpadding="2">
           ...
           <tr>
               ...
               <td class="bold">Amount Paid <del style="text-decoration-style: double">MK</del></td>
               <td class="bold">Balance <del style="text-decoration-style: double">MK</del></td>
           </tr>
           </thead>
            <tbody>
        ...
        <div class="bold arial" style="text-align: center; float:right; width: 200px; padding: 5px; margin-right:30px">
            ...
            <div  style="padding: 10px 20px; width: 200px; background-color: lightyellow;">
                <span  style="font-size: 25px;">{{ $pr->paid ? 'CLEARED' : $pr->balance }}.00</span>
            </div>
        </div>
        <div class="clear"></div>
    </div>
