...
<table style="width:100%; border-collapse:collapse; ">
    ...
    <tr>
        ...
        <td><strong>STUDENT NO:</strong> {{ $sr->adm_no }}</td>
    ...
    <tr>
        ...
        <td><strong>TOTAL STUDENTS:</strong>&nbsp;&nbsp;{{Qs::totalStudents( $section_id) }}</td>
        <td><strong>POSITION:</strong>&nbsp;{{ ($exr->pos) }}</td>
    </tr>
...
<table style="width:100%; border-collapse:collapse; border: 1px solid #000; margin: 10px auto;" border="1">
    ...
    <tr>
        ...
        <th rowspan="2">EXAM SCORE<br>(100%)</th>
