                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Phone:</label>
                                        <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="+265" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('phone2') }}" type="text" name="phone2" class="form-control" placeholder="+265" >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                {{--LGA--}}
                                <div class="col-md-4">
                                    <label for="lga_id">Country: <span class="text-danger">*</span></label>
